...
This repository contains my hands-on Azure learning journey.
...
- [✔] Day 3 – RBAC
- [✔] Day 4 – Azure Storage
- [✔] Day 5 – Storage Lifesycle Management
- [✔] Day 6 - Virtual Network(VNet)
- [✔] Day 7 - Network Security Group(NSG)
- [✔] Day 8 - Virtual Machines (VMs)
- [✔] Day 9 - Managed Disks & Snapshots
